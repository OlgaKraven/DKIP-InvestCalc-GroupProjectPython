...
```mermaid
flowchart TB
    A[Клиент / UI<br/>веб-приложение, Postman]--> B[FastAPI API<br/>– маршруты<br/>– запрос/ответ JSON]
    B --> C[Сервисный слой<br/>Логика расчётов:<br/>• TCO<br/>• ROI<br/>• Payback<br/>• Sensitivity]
    C --> D[Модели данных<br/>Pydantic schemas]
```
