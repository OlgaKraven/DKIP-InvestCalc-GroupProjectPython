# ADR-12: Стратегия валидации запросов и ответов

## 1. Контекст и постановка задачи

Данный ADR фиксирует архитектурное решение по теме «Стратегия валидации запросов и ответов» в рамках учебного проекта InvestCalc. Система предназначена для расчёта экономической эффективности информационных систем (TCO, ROI, срок окупаемости, анализ чувствительности) и используется в образовательном процессе СПО. В решении описываются исходные предпосылки, ограничения, альтернативы и последствия выбора.
...
- ADR-11: Стратегия версионирования API
- ADR-13: Обработка ошибок на уровне API
...
flowchart TD
    ...
    B --> C[Компонент: Стратегия валидации запросов и ответов]
