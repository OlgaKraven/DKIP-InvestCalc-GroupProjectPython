# ADR-02: Архитектурный стиль: модульный монолит

## 1. Контекст и постановка задачи

Данный ADR фиксирует архитектурное решение по теме «Архитектурный стиль: модульный монолит» в рамках учебного проекта InvestCalc. Система предназначена для расчёта экономической эффективности информационных систем (TCO, ROI, срок окупаемости, анализ чувствительности) и используется в образовательном процессе СПО. В решении описываются исходные предпосылки, ограничения, альтернативы и последствия выбора.
...
- ADR-01: Архитектурное видение и ограничения
- ADR-03: Разделение домена: слои API / Domain / Services / Infrastructure
...
flowchart TD
    ...
    B --> C[Компонент: Архитектурный стиль: модульный монолит]
